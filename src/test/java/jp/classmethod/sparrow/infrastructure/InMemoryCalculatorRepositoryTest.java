...
public class InMemoryCalculatorRepositoryTest {
	...
	public void testFindByUser() {
		...
		assertThat(actual.get(0).getTimestamp(), is(2017052600L));
		...
		assertThat(actual.get(1).getTimestamp(), is(2017052610L));
		...
		assertThat(actual.get(2).getTimestamp(), is(2017052611L));
		...
		assertThat(actual.get(3).getTimestamp(), is(2017052612L));
		...
		assertThat(actual.get(4).getTimestamp(), is(2017052613L));
